...
id: decision_e7e2f0e0_e2193c
tags:
- critical-fix
- startup
- mcp
- performance
timestamp: 1764022013
type: decision
---

Fixed MCP startup delay FOR GOOD - heavy imports now run in asyncio.to_thread() so they don't block the event loop. Added extensive comments and documentation to prevent regression. The key insight: Python imports are synchronous and block even inside async functions!
