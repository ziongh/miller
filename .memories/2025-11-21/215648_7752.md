...
git:
  ...
  - uv.lock
id: checkpoint_e630024c_7b3d75
tags:
- toon
- hierarchical
- fast-refs
- bug-fix
timestamp: 1763697408
type: checkpoint
---

Fixed critical fast_refs TOON implementation - now uses hierarchical TOON (FastRefsFlattener) instead of raw toon_encode on nested dict, matching trace_call_path pattern for 60%+ token reduction
