...
- workspace-paths
- verified
timestamp: 1763923015
type: checkpoint
---

Major indexing system overhaul complete and tested: 1) .millerignore with smart vendor detection, 2) Staleness detection (file mtime vs DB), 3) New file detection at startup, 4) Fixed UNIQUE constraints (INSERT OR REPLACE), 5) Fixed per-workspace database paths. Verified working on restart - index correctly detected as up-to-date.
