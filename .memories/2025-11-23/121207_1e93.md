...
- indexing
- ignore-patterns
timestamp: 1763921527
type: checkpoint
---

Implemented comprehensive indexing improvements: 1) .millerignore support with smart vendor detection (auto-generates on first run, detects libs/, vendor/, jquery/bootstrap files), 2) Staleness detection comparing file mtimes to DB timestamp, 3) New file detection at startup. Uses pathspec library for gitignore-compatible patterns. 629/630 tests pass.
