...
id: checkpoint_8e98849d_345b85
tags:
- bug-fix
- storage
- atomic-update
- sqlite
timestamp: 1763917551
type: checkpoint
---

Fixed incremental_update_atomic identifier INSERT - was using wrong column names (line, column) and missing 9 required columns. Changed to match 16-column schema from add_identifiers_batch. All 630 tests pass.
