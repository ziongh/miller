...
id: learning_b65e6f51_08f75b
tags:
- skills
- structure
- fix
- claude-code
timestamp: 1764102175
type: learning
---

Fixed skill directory structure. Skills require subdirectory per skill with SKILL.md inside (not standalone .md files). Restructured all 9 skills from .claude/skills/name.md to .claude/skills/name/SKILL.md format.
