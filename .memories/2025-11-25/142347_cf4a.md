...
id: learning_45dbdb97_546f32
tags:
- skills
- structure
- verified
- claude-code
timestamp: 1764102227
type: learning
---

Confirmed skills system working after fixing directory structure. Skills require: subdirectory per skill + SKILL.md file inside. Tested detect-n-plus-one skill successfully - showed 'Launching skill' and 'skill is running' messages, then expanded content.
