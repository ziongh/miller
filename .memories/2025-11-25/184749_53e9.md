...
id: checkpoint_34f2f1cc_ea5cdc
tags:
- cleanup
- fast-goto
- tool-removal
timestamp: 1764031669
type: checkpoint
---

Removed fast_goto MCP tool - it was redundant with fast_search and get_symbols. Removed from server.py, tools_wrappers.py, test_server.py, and instructions.md. Implementation kept in goto_refs_wrapper.py for potential internal use.
