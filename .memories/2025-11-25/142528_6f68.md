...
git:
  ...
  - .claude/skills/detect-empty-catch/
  - .claude/skills/detect-hardcoded-secrets/
  - .claude/skills/detect-n-plus-one/
  ...
  - .memories/2025-11-25/141632_f294.json
  - .memories/2025-11-25/142255_47c7.json
  - .memories/2025-11-25/142347_cf4a.json
  - .memories/plans/plan_miller-performance-optimization-sprint.json
id: checkpoint_06dceef5_ffb03c
tags:
- skills
- review
- tools
- miller
timestamp: 1764102328
type: checkpoint
---

Reviewed all 9 skills for correct tool references. All use mcp__miller__* tools correctly. No Julie references remain. Key differences: Miller doesn't have fast_goto (use get_symbols with target) or fuzzy_replace (use Edit tool).
