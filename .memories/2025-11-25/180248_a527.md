...
id: learning_f775d03c_cfc492
tags:
- architecture
- semantic-search
- polyglot
- cross-language
timestamp: 1764028968
type: learning
---

Key insight: Use semantic embeddings for cross-language symbol correlation. Connect TypeScript IUser ↔ C# UserDto ↔ SQL Users table via embedding similarity. Can power polyglot trace_call_path, fast_refs across language boundaries, and multi-language rename cascades.
